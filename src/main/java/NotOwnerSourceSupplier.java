...
public class NotOwnerSourceSupplier implements ProcessorMetaSupplier {
	private Address ownerAddress;
	private String partitionKeyString;
	private Class<? extends AbstractProcessor> source;

	public NotOwnerSourceSupplier(String partitionKeyString, Class source) {
...
//                return new CloseableProcessorSupplier<>(() -> new WebcamSource());
            	return c -> Collections.singletonList(Processors.noopP().get());
            	}
